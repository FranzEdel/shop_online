...
<div class="menu">
	...
	<div class="menu_search">
		<form action="#" id="menu_search_form" class="menu_search_form">
			...
			<button class="menu_search_button"><img src="http://localhost/shop_online/public/asset/http://localhost/shop_online/public/asset/images/search.png" alt=""></button>
		</form>
	</div>
	<!-- Navigation -->
	<div class="menu_nav">
	...
	<div class="menu_contact">
		<div class="menu_phone d-flex flex-row align-items-center justify-content-start">
			<div><div><img src="http://localhost/shop_online/public/asset/images/phone.svg" alt="https://www.flaticon.com/authors/freepik"></div></div>
			...
			<div class="logo">
				<a href="#">
					<div class="d-flex flex-row align-items-center justify-content-start">
						<div><img src="http://localhost/shop_online/public/asset/images/logo_1.png" alt=""></div>
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				...
				<div class="header_search">
					<form action="#" id="header_search_form">
						<input type="text" class="search_input" placeholder="Search Item" required="required">
						<button class="header_search_button"><img src="http://localhost/shop_online/public/asset/images/search.png" alt=""></button>
					</form>
				</div>
				
				<!-- Cart -->
				<div class="cart"><a href="cart.html"><div><img class="svg" src="http://localhost/shop_online/public/asset/images/cart.svg" alt="https://www.flaticon.com/authors/freepik"><div>1</div></div></a></div>
				<!-- Phone -->
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_about">
								<div class="footer_logo">
									<a href="#">
										<div class="d-flex flex-row align-items-center justify-content-start">
											<div class="footer_logo_icon"><img src="http://localhost/shop_online/public/asset/images/logo_2.png" alt=""></div>
											<div>Jhonatan Shop</div>
										</div>
									</a>		
								</div>
